...
<body>
	...
	if (userID == null) {
		...
		if (eva.getEvaTitle() == null || eva.getEvaSubject() == null || eva.getEvaTeacher() == null
		|| eva.getEvaContent() == null || eva.getEvaScore() == null) {
			PrintWriter script = response.getWriter();
			script.println("<script>");
			...
			int result = evaDAO.write(userID, eva.getEvaTitle(), eva.getEvaSubject(), eva.getEvaTeacher(),
			eva.getEvaContent(), eva.getEvaScore());
			if (result == -1) {
		PrintWriter script = response.getWriter();
		script.println("<script>");
