...
<body>
	...
	String search_userID = um.id_search2(userName, userEmail); //아이디를 디비에서 가져옴..실패시 널
	if (search_userID != null) { //아이디 찾기 성공시
	...
	<div id="kk">
		...
		<div id="login">
			...
			<h2 class="selected1">아이디 찾기</h2>
			<div id="login_con">
				<div id="login1" class="login_box">
					<form name="idsearch" class="pwsearch">
						<table class="table">
							<%
							...
							<tr>
								<td class="userfind"><%=search_userID%></td>
							</tr>
							<tr>
							...
							%>
							<tr>
								<td class="userfind1">없는 아이디입니다.</td>
							</tr>
							<tr>
								<td><input type="button" value="돌아가기"
									onClick="history.back()"></td>
